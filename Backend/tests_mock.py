...
class MockEmbeddingProvider(EmbeddingProvider):
    ...
    async def generate_embedding(self, text: str) -> list[float]:
        ...
        normalized = text
        if (
            "What language do I like" in text
            or "I like Python" in text
            or "My favorite language is Python" in text
        ):
...
class MockAIProvider(AIProvider):
    ...
    async def generate(self, prompt: str) -> GenerationResult:
        ...
        if 'User message:\n"""My name is Prince."""' in prompt:
            text = (
                '{"action": "save", "memory": "My name is Prince.", '
            ...
            text = (
                '{"action": "save", "memory": "Actually my favorite color is green.", '
            ...
            text = (
                '{"action": "save", "memory": "My favorite color is blue.", '
                '"type": "preference", "importance": 0.75}'
            )
        elif 'User message:\n"""My favorite language is Python."""' in prompt:
            text = (
                '{"action": "save", "memory": "My favorite language is Python.", '
                '"type": "preference", "importance": 0.75}'
            )
        elif 'User message:\n"""Forget that I like Python."""' in prompt:
            text = (
                '{"action": "forget", "memory": "I like Python.", '
                '"type": "other", "importance": 0.0}'
            )
        elif 'User message:\n"""I like Python."""' in prompt:
            text = (
                '{"action": "save", "memory": "I like Python.", '
                '"type": "preference", "importance": 0.75}'
            )
        elif 'User message:\n"""I moved to Surat."""' in prompt:
            text = (
                '{"action": "save", "memory": "I moved to Surat.", '
                '"type": "location", "importance": 0.85}'
            )
        elif 'New memory: "I moved to Surat."' in prompt:
            text = '{"replace": true, "confidence": 0.95, "reason": "moved"}'
        elif 'User message:\n"""I live in Ahmedabad."""' in prompt:
            text = (
                '{"action": "save", "memory": "I live in Ahmedabad.", '
                '"type": "location", "importance": 0.85}'
            )
        else:
            if "action =" in prompt:
